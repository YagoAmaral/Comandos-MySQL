/* Comando DROP TABLE IF EXISTS é utilizado para excluir tabelas existentes */
 -- O comando pode ser utilizado também somente com DROP --
...
/* Comando CREATE TABLE é utilizado para criar tabelas */
